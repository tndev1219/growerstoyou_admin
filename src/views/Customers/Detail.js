...
class CustomerDetail extends Component {
  ...
  render() {
    ...
    const { customerData, processing } = this.state;
    ...
    return (
      <div className="animated">
        ...
        :
          <Card>
            <CardHeader>
              <i className="icon-menu"></i>{customerData.fname} {customerData.lname}'s Information
            </CardHeader>
            <CardBody className="p-5">   
              <Row>
                <Col xs="12" sm="3" md="3" lg="2" className="mb-4">
                  {customerData.avatar ? 
                    <img src={`https://growertoyou-dev.s3.amazonaws.com/public/${customerData.avatar}`} alt="avatar" style={{width: '80%', borderRadius: 200, margin: "auto", display: 'block'}} />
                  :
                ...
                <Col xs="12" sm="9" md="9" lg="10">
                  ...
                  <Row className="pb-4">
                    ...
                    <Col xs="8" sm="8" md="9" lg="9">
                      <span>{customerData.address}, {customerData.city}, {customerData.state} {customerData.zipcode}</span>
                    </Col>
                  </Row>
                  <Row className="pb-4">
                    <Col xs="4" sm="4" md="3" lg="3">
                  ...
                  <Row className="pb-4">
                    ...
                    <Col xs="8" sm="8" md="9" lg="9">
                      {parseInt(customerData.status) === 0 ? <Badge color="warning">Inactive</Badge> : <Badge color="info">Active</Badge>}
                    </Col>
                  </Row>
                  <Row>
                    <Col xs="12" sm="12" md="12" lg="12">
                      <Button 
                        className="mr-4" 
                        color="warning" 
                        disabled={parseInt(customerData.status) === 0 ? true : false || processing} 
                        onClick={ () => this.handleActive(this.props.match.params.id, customerData.status) }
                        style={{float: 'right'}}
                      >
                      ...
                      <Button 
                        className="mr-4" 
                        color="info" 
                        disabled={parseInt(customerData.status) === 1 ? true : false || processing} 
                        onClick={ () => this.handleActive(this.props.match.params.id, customerData.status) }
                        style={{float: 'right'}}
                      >
